...
const  DownloadedVideo = () => {
    ...
    return (
        ...
        src="/download.png"
        className={` ${true ? "hidden":""} ${true ? "hidden":""} h-full w-auto hover:scale-110 transition-transform duration-300`}
        alt=""
        />
        <img
        // onClick={()=>{
        ...
        // }}
        src="/pause.png"
        className={` ${false ? "":"hidden"} ${true ? "hidden":""} h-full w-auto hover:scale-110 transition-transform duration-300`}
        alt=""
        />
        <img
        onClick={()=>{
        ...
        src="/right.avif"
        className={` ${false ? "":"hidden"} h-full w-auto hover:scale-110 transition-transform duration-300`}
        alt=""
        />
        </div>
        </div>
        ...
        1 == 1 && (
        <>
        <div className={` ${false ? "hidden":""} w-full p-4 bg-white h-44`} >
        <video controls muted autoPlay  src={videoUrls} className={` ${false ? "hidden":""} w-full h-full`} ></video>
        <div className={` ${true ? "":"hidden"} w-full h-full bg-gray-300 text-red-300 flex justify-center items-center`}>
                   <span className='text-blue-300 font-semibold' >YOU NEED TO CONNECT YOUR DEVICE TO INTERNET</span>
        </div>
        </div>
        <div className={` ${true ? "":"hidden"} flex flex-col items-center justify-center space-y-4 p-6`}>
